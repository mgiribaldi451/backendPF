...
app.get('/', function (req, res) {
    ...
    var prodejs = getProductos();
    console.log(prodejs.data);
    prodejs = prodejs.data;
...
function getProductos() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, axios_1["default"].get("http://localhost:8080/api/productos/").then(function (res) {
                    console.log("RES: ", res);
                    return res.data;
                })];
        });
